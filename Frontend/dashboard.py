...
class Hotel:
    def __init__(self, root):
        ...
        # ---------------------------------BUTTON FUNCTION DEPARTMENT---------------------------#
        def iExit():
            iExit = tkinter.messagebox.askyesno("Softwaica Hotel",
                                                "Confirm if you want to exit*YOU  ARE ABOUT TO MISS A LIFETIME EXPERIENCE BUDDY")
            if iExit > 0:
                root.destroy()
                return
        ...
        # ------------------------------------LEFT FRAME--------------------------#
        self.lblCustomer_Ref = Label(LeftFrame, font=("arial", 12, "bold"), text="CustomerRef", padx=2, pady=2,
                                     bg="gray")
        ...
        self.cboNationality = ttk.Combobox(LeftFrame, textvariable=Nationality, state="read only",
                                           font=("arial", 12, "bold"), width=18)
        self.cboNationality["value"] = (
        "", "British", "American", "Nepali", "Indian", "Chinese", "French", "German", "African", "Australian")
        ...
        self.cboIDtype = ttk.Combobox(LeftFrame, textvariable=IDtype, state="read only", font=("arial", 12, "bold"),
                                      width=18)
        self.cboIDtype["value"] = (
        "", "Citizenship", "Driving Liscence", "Student IDs", "Transport Card", "Passport", "Any other valid id")
        ...
        self.cboGender = ttk.Combobox(LeftFrame, textvariable=Gender, state="read only", font=("arial", 12, "bold"),
                                      width=18)
        self.cboGender["value"] = ("", "Male", "Female", "Any Other")
        self.cboGender.current(0)
        self.cboGender.grid(row=10, column=1, pady=3, padx=20)

        self.lblCheckInDate = Label(LeftFrame, font=("arial", 12, "bold"), text="CheckInDate(d/m/y)", padx=2, pady=2,
                                    bg="gray")
        ...
        self.lblCheckOutDate = Label(LeftFrame, font=("arial", 12, "bold"), text="CheckOutDate", padx=2, pady=2,
                                     bg="gray")
        ...
        self.cboMealtype = ttk.Combobox(LeftFrame, textvariable=Mealtype, state="read only", font=("arial", 12, "bold"),
                                        width=18)
        ...
        self.cboRoomtype = ttk.Combobox(LeftFrame, textvariable=Roomtype, state="read only", font=("arial", 12, "bold"),
                                        width=18)
        ...
        self.lblDays = Label(RightFrame, font=("arial", 14, "bold"), text="Number of Days", bd=7, bg="white",
                             fg="black", )
        self.lblDays.grid(row=2, column=0, sticky=W)
        self.txtDays = Entry(RightFrame, font=("arial", 14, "bold"), textvariable=TotalDays, bd=7, bg="sky blue",
        ...
        self.txtPaidTax = Entry(RightFrame, font=("arial", 14, "bold"), textvariable=PaidTax, bd=7, bg="skyblue",
                                width=50, justify=LEFT)
        self.txtPaidTax.grid(row=3, column=1)

        self.lblSubTotal = Label(RightFrame, font=("arial", 14, "bold"), text="SubTotal", bd=7, bg="white",
                                 fg="black", )
        self.lblSubTotal.grid(row=4, column=0, sticky=W)
        self.txtSubTotal = Entry(RightFrame, font=("arial", 14, "bold"), textvariable=SubTotal, bd=7, bg="skyblue",
                                 width=50, justify=LEFT)
        self.txtSubTotal.grid(row=4, column=1)

        self.lblTotalCost = Label(RightFrame, font=("arial", 14, "bold"), text="TotalCost", bd=7, bg="white",
                                  fg="black", )
        self.lblTotalCost.grid(row=5, column=0, sticky=W)
        self.txtTotalCost = Entry(RightFrame, font=("arial", 14, "bold"), textvariable=TotalCost, bd=7, bg="skyblue",
                                  width=50, justify=LEFT)
        self.txtTotalCost.grid(row=5, column=1)

        self.search = Label(RightFrame, padx=13, pady=1, bd=4, fg="black", font=("arial", 13, "bold"), width=20,
                            height=1, bg="sky blue", cursor="hand2", text="Search by customer ref").grid(row=6,
                                                                                                         column=0,
                                                                                                         padx=5)
        ...
        # ---------------------------BUTTON DEPARTMENT-----------------------------#
        self.btnTotal = Button(BottomFrame, padx=16, pady=1, bd=4, fg="black", font=("arial", 13, "bold"), width=21,
                               height=2, bg="skyblue", cursor="hand2", text="Total", command=TotalCostandDate).grid(
            row=0, column=4, padx=4)

        self.btnReceipt = Button(BottomFrame, padx=16, pady=1, bd=4, fg="black", font=("arial", 13, "bold"), width=21,
                                 height=2, bg="skyblue", cursor="hand2", text="Receipt", command=Receipt).grid(row=0,
                                                                                                               column=5,
                                                                                                               padx=5)

        self.btnReset = Button(BottomFrame, padx=16, pady=1, bd=4, fg="black", font=("arial", 13, "bold"), width=21,
                               height=2, bg="skyblue", cursor="hand2", text="Reset", command=Reset).grid(row=0,
                                                                                                         column=6,
                                                                                                         padx=5)

        self.btnExit = Button(BottomFrame, padx=16, pady=1, bd=4, fg="black", font=("arial", 13, "bold"), width=21,
                              height=2, bg="skyblue", cursor="hand2", text="Exit", command=iExit).grid(row=0, column=7,
                                                                                                       padx=5)

        self.btnSearch = Button(BottomFrame, padx=16, pady=1, bd=4, fg="black", font=("arial", 13, "bold"), width=21,
                                height=2, bg="skyblue", cursor="hand2", text="Search").grid(row=0, column=8, padx=5)
